...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClickPlus = function (_React$Component) {
	  _inherits(ClickPlus, _React$Component);

	  function ClickPlus(props) {
	    _classCallCheck(this, ClickPlus);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ClickPlus).call(this, props));

	    _this.clickPlus = _this.clickPlus.bind(_this);

	    return _this;
	  }

	  _createClass(ClickPlus, [{
	    key: 'clickPlus',
	...
	var ClickMinus = function (_React$Component2) {
	  _inherits(ClickMinus, _React$Component2);

	  function ClickMinus(props) {
	    _classCallCheck(this, ClickMinus);

	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(ClickMinus).call(this, props));

	    _this2.clickMinus = _this2.clickMinus.bind(_this2);
	    return _this2;
	  }

	  _createClass(ClickMinus, [{
	    key: 'clickMinus',
	    value: function clickMinus() {
	  ...
	  _createClass(Counter, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(ClickPlus, { actions: actions }),
	        _react2.default.createElement(ClickMinus, { actions: actions })
	      );
	    }
	  }]);
